...
module.exports = async message => {
  ...
  if (config.commandChannel &&
    message.channel.id === config.commandChannel.id &&
    (message.channel.type === 'dm' ||
      (message.mentions.users &&
      message.mentions.users.has(config.discord.client.user.id)))) return handleCommand(message.content)
  ...
  threads.forEach(threadID => config.messenger.client.sendMessage(msg, threadID, sentMessageCallback))
}

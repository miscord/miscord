...
function getConfig () {
  ...
  // added for backwards compatibility, discord.showUsername is deprecated
  if (!config.facebook.showUsername) config.facebook.showUsername = config.discord.showUsername
  return config
}

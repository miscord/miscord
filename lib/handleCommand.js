...
module.exports = (message, sender) => {
  ...
  if (command === 'eval' && !discord.guilds.getAll('members').find(member => member.id === sender.id).hasPermission('ADMINISTRATOR')) return discord.channels.command.send(`You have no permission!`)

...
module.exports = async params => {
  var { name, config, topic, isLinked } = params
  ...
  log.silly('getChannel: existing channel', channel)
  ...
  if (config.discord.category) channel.setParent(config.discord.category)

...
module.exports = opts => {
  ...
  log.silly('createEmbed', 'Thread: %o', thread)
  log.silly('createEmbed', 'Sender: %o', sender)
  log.silly('createEmbed', 'Message: %o', message)
  ...
  if (attach[0].type === 'photo' || attach[0].type === 'sticker') return embed.setImage(attach[0].url)
